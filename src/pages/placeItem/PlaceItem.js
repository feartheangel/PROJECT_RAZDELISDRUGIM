      ...
      <div style={allDiv}>
        <form>
          <ol>
            ...
            <li>
              <label>
                <span>*</span> Название товара: <input type="text" name="maks" />
              </label>
            </li>
            ...
            <li>
              <label>
                <span>*</span> Стоимость аренды: <input type="number" />
                <select>
                  <option>Час</option>
                  <option>Сутки</option>
                  <option>Неделя</option>
            ...
            <label>
              Страхование <input type="checkbox" name="a" value="1417" />{' '}
            </label>

            <label>
              Залог <input type="checkbox" name="a" value="1417" />{' '}
            </label>

            <label>
              Сервисный сбор <input type="checkbox" name="a" value="1417" />{' '}
            </label>

            <label>
              Отдам бесплатно <input type="checkbox" name="a" value="1417" />{' '}
            </label>

            <label>
              Готов продать <input type="checkbox" name="a" value="1417" />{' '}
            </label>
