        ...
        <form encType="multipart/form-data" method="post">
          <ol>
            ...
            <div>
              ...
              <textarea value={commentsItem} onChange={(e) => setCommentsItem(e.target.value)} />
            </div>
            ...
            <li>
              <div>
                ...
                <select value={timeArends} onChange={(e) => setTimeArends(e.target.value)}>
                  <option />
                  <option>Час</option>
                  <option>Сутки</option>
                  <option>Неделя</option>
            ...
            <li style={{ marginLeft: '7px' }}>
              <div>
                ...
                <select value={valuts} onChange={(e) => setValuts(e.target.value)}>
                  <option />
                  <option>$</option>
                  <option>€</option>
                  <option>рубли</option>
            ...
            <li style={{ marginLeft: '7px' }}>
              <div>
                ...
                <select value={timeReceipt} onChange={(e) => setTimeReceipt(e.target.value)}>
                  <option />
                  <option>1ч</option>
                  <option>2ч</option>
                  <option>3ч</option>
            ...
            <li style={{ marginLeft: '7px' }}>
              <div>
                Укажите время подготовки товара: <input type="number" />
                <select>
                  <option />
                  <option>Часы</option>
                  <option>Сутки</option>
            ...
            <li style={{ marginLeft: '7px' }}>
              <div>
                Вид доставки:{' '}
                <select onChange={(e) => typeDeliveryHandler(e)}>
                  <option />
            ...
            <li style={{ marginLeft: '7px' }}>
              <div>
                Страхование <input type="checkbox" value={insurance} onChange={insuranceHandler} />{' '}
              </div>

              {insurance && (
                <p style={{ marginTop: '20px' }}>
                  {' '}
                  Введите сумму: <input type="number" />
                  <br />
                  Наличие франшизы:{' '}
                  <input
            ...
            <li style={{ marginLeft: '7px' }}>
              <div>
                Залог <input type="checkbox" value={pladge} onChange={pladgeHandler} />{' '}
                {pladge && (
            ...
            <li style={{ marginLeft: '7px' }}>
              <div>
                Сервисный сбор{' '}
                <input type="checkbox" value={serviceFee} onChange={serviceFeeHandler} />{' '}
                {serviceFee && (
                  <p style={{ marginTop: '10px' }}>
                    <select onChange={(e) => serviceHandler(e)}>
                      <option />
            ...
            <div style={{ margin: '30px auto' }}>
              ...
              <input
                ...
                name="a"
                value="Очистить"
                style={{ width: '40%', float: 'left', height: '30px' }}
              />{' '}
            </div>
          </ol>
        </form>
