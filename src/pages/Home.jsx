        ...
        <section className="abilities">
          <div className="abilities-content">
            ...
            <div className="abilities-cards">
              ...
              <div className="abilities-card">
                ...
                <p className="abilities-card-p">
                  ...
                  через поиск или на карте, возможно, вы уже сегодня возьмете ее в аренду у соседа
                  по подъезду
                </p>
              </div>
              <div className="abilities-card">
              ...
              <div className="abilities-card">
                ...
                <p className="abilities-card-p">
                  ...
                  страхования и составления необходимых бумаг. И еще… Мы не храним у себя данные
            ...
            <div className="abilities-buttons">
              ...
              <input
                type="button"
                value="Преложить вещь"
                className="abilities-button-give-subject"
              />
            </div>
          </div>
        </section>
          ...
          <div className="reviews-blocks">
            <div className="reviews-block">
              ...
              <p className="review-text">
                Брал в аренду детское автокресло на данном сайте. Быстро и удобно. спасибо за
                отличный сервис!
              </p>
            </div>
            <div className="reviews-block">
            ...
            <div className="about-middle-part">
              ...
              <div className="about-middle-right">
                <p className="about-main-p">
                  ...
                  современного человека если  и присутствует, то используется крайне редко, может
                  быть 1–2 раза в год, а иногда и того реже. Я давно хотел найти механизм
                  монетизировать его, не избавляясь при этом, предоставляя возможность другим людям
                  облачиться в него, когда это будет необходимо. Когда я посмотрел
                  на мои строительные и музыкальные инструменты, автоаксессуары, моющий пылесос,
                  садовую технику — я понял, что таких вещей может быть много. В разговоре с моими
                  друзьями и знакомыми я понял, что у них стоит та же проблема, причём с одной
                  стороны, у них пылятся вещи, которые могли бы служить другим, с другой стороны,
                  им иногда нужны другие вещи, для разового или редкого использования. Да,
                  есть компании, которые занимаются арендой одежды, инструментов, аксессуаров и т.п.
                  Однако наша идея заключается в том, чтобы дать простым людям простой инструмент
                  выхода на рынок краткосрочной аренды вещей, как в качестве Владельцев,
                  так в качестве Рентеров чужих вещей. И об этом наша платформа…
                </p>
              </div>
            </div>
            ...
            <div className="news-reviews-blocks">
              <div className="news-reviews-block">
                ...
                <p className="news-reviews-text">
                  ...
                  проблемами перепроизводства и выбирают осознанное потребление, а другие просто
                  хотят сэкономить.{' '}
                </p>
              </div>
              <div className="news-reviews-block">
